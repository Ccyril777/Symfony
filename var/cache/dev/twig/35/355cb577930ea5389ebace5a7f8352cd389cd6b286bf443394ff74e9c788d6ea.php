...
{% block panel %}
    ...
    {% endfor %}
{% endblock %}
", "@Debug/Profiler/dump.html.twig", "/home/salazhar/Documents/Symfony/Quête Symfony/wild-series/vendor/symfony/debug-bundle/Resources/views/Profiler/dump.html.twig");
    }
}
